...
#ifndef FZWORKOUTKIT_SWIFT_H
#define FZWORKOUTKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FZWorkoutKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface GoModeController (SWIFT_EXTENSION(FZWorkoutKit)) <UICollectionViewDataSource>
...
@interface GoVideoController (SWIFT_EXTENSION(FZWorkoutKit)) <AVPictureInPictureControllerDelegate>
- (void)pictureInPictureControllerWillStopPictureInPicture:(AVPictureInPictureController * _Nonnull)_;
@end

@interface GoVideoController (SWIFT_EXTENSION(FZWorkoutKit)) <UIToolbarDelegate>
@end
